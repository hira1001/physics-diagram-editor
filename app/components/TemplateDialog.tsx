...
const templates: Array<{
  ...
  { id: "incline", name: "粗い斜面上の物体", description: "斜面・物体・基本3力", detail: "θ / m / mg / N / f", icon: Slash },
  { id: "smooth-incline", name: "滑らかな斜面", description: "摩擦なしの斜面", detail: "θ / m / mg / N", icon: Slash },
  { id: "horizontal", name: "粗い水平面", description: "床上の物体と外力", detail: "m / mg / N / f", icon: Slash },
  { id: "rough-wall", name: "粗い壁と物体", description: "壁面の摩擦を含む", detail: "m / mg / N / f", icon: Slash },
