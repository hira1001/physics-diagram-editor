...
export const PHYSICS_COMPONENT_CATALOG: readonly ComponentCatalogEntry[] = [
  ...
  entry("rough-floor", "粗い床", "接触面", 190, 24, "", ["摩擦あり床", "あらい床"], ["上向き法線", "摩擦", "摩擦係数", "接触"]),
  entry("smooth-wall", "滑らかな壁", "接触面", 190, 24, "", ["摩擦なし壁", "なめらかな壁"], ["水平法線", "摩擦なし", "接触"]),
  entry("rough-wall", "粗い壁", "接触面", 190, 24, "", ["摩擦あり壁", "あらい壁"], ["水平法線", "摩擦", "摩擦係数", "接触"]),
  ...
  entry("moment-diagram", "曲げモーメント図 (BMD)", "ベクトル", 180, 70, "M", ["BMD", "モーメント分布"], ["断面力", "曲げ"]),
